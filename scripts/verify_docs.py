...
def verify_documentation() -> bool:
    ...
    if README_PATH.exists():
        ...
        if "tests-623%20passed" in readme_text or "tests-623 passed" in readme_text:
            checks_passed += 1
            print(f"[OK] Production Test Suite Badge (623 passed) verified in README.md.")
        else:
            errors.append("README.md: Test badge does not match 623 passed")
