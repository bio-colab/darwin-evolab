...
[![Tests Passing](https://img.shields.io/badge/tests-664%20passed-brightgreen.svg)](https://github.com/bio-colab/darwin-evolab)
...
```
tests/ (Core, Koza Parsimony, Miller CGP, Holland Schema, SWE-bench, Sky130, EDA, UX, Signals, Checkpoints, UNIX Toolchain) : 588 passed (100%)
...
==================================================================================================================
Total Automated Test Suite                                                                                        : 664 passed (100%)
```
