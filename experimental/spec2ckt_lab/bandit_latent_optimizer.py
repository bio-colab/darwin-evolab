...
Performs rapid test-time optimization on the conditioned latent manifold
without requiring retraining. Uses Upper Confidence Bound (UCB1) multi-armed bandit
search to refine the initial seed population within milliseconds.
"""
...
class BanditLatentOptimizer:
    ...
    def optimize_seeds(
        ...
        for trial in range(budget_trials):
            ...
            # If better than current arm, replace arm's center
        ...
        # Sort arms by fitness descending and return their sizings
