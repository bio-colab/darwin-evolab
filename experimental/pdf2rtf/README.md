...
| **Ablate `align_tolerance_pt`** | $20.0\text{ pt}$ (سماحية فضفاضة) | $98.74\%$ | $-0.37\%$ | **$91.67\%$** | تشوه تصنيف المحاذاة الموسطة واليمنى |
| **Ablate `line_spacing_round_pt`** | $5.0\text{ pt}$ (شبكة خشنة) | $99.07\%$ | $-0.03\%$ | $100.00\%$ | تذبذب طفيف في المسافات البينية |
