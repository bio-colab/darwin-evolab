...
6. **فحص سلوك تباعد الأسطر في Word (`Format.LineSpacing`)**:
   - توثيق أن خاصية `p.Format.LineSpacing` في كائنات Word COM هي خاصية نمط ثابتة موروثة من نمط "Normal" القياسي (تساوي 13.9pt لمضاعف 1.15) ولا تتغير ديناميكياً مع أحجام خطوط المقاطع.
   - تأكيد أن بوابات التحكيم (Gate 2 و Gate 3) مستقلة عن هذه القيمة وتعتمد حصرياً على المسافات المادية والحدود المترية المستخرجة فعلياً من PDF.
